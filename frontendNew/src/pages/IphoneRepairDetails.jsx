...
import seImage from "../assets/iphone.png";
...
const iphoneModels = [
  ...
  { model: "iPhone 8 Plus", screenRepair: 80, batteryReplacement: 50, backRepair: 90, image: iphoneImage },
  { model: "iPhone 8", screenRepair: 75, batteryReplacement: 45, backRepair: 90, image: iphoneImage },
  { model: "iPhone 7 Plus", screenRepair: 70, batteryReplacement: 45, backRepair: 90, image: iphoneImage },
  { model: "iPhone 7", screenRepair: 70, batteryReplacement: 45, backRepair: 85, image: iphoneImage },
  { model: "iPhone 6 Plus", screenRepair: 50, batteryReplacement: 40, backRepair: 60, image: iphoneImage },
  { model: "iPhone 6", screenRepair: 50, batteryReplacement: 40, backRepair: 60, image: iphoneImage },
  { model: "iPhone 6s", screenRepair: 60, batteryReplacement: 40, backRepair: 75, image: iphoneImage }
];
